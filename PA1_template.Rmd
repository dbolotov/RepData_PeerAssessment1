...
These values differ from the estimates where NA values were omitted.The following code plots these data on the same panel. Since the mean value was used to fill missing values.
```{r}
